...
from cw<%= appname%>.items import CacheItem, HistoryItem
from cw<%= appname%>.parser.utils.section_item import SectionItem
...
class MysqlDBTest(unittest.TestCase):
    def setUp(self):
        ...
        self._ads_item = Ad.get_default(
            ...
            _image_link="https://img1cdn.<%= appname%>.com.sa/userfiles30/2015-07-18/55aa1ba3366cd.jpeg,https://img1cdn.<%= appname%>.com.sa/userfiles30/2015-07-18/55aa1bab49a3b.jpeg,https://img1cdn.<%= appname%>.com.sa/userfiles30/2015-07-18/55aa1bb0b6ca6.jpeg",
    ...
    #     self._cache_db.save_cache(CacheItem.get_default(model_id,self._page_url,self._page_from))
